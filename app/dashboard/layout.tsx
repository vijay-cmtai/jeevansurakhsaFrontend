...
export default function DashboardLayout({
  ...
  useEffect(() => {
    ...
    if (status !== "loading") {
      ...
      if (!userInfo) {
        ...
        // If user is authenticated, stop checking
  ...
  // Once authentication is confirmed, render the member dashboard
  return (
    <div className="h-screen w-full flex bg-gray-100 overflow-hidden">
      {/* Sidebar for Desktop (Static) */}
      <div className="hidden lg:block flex-shrink-0 bg-gray-800">
        <Sidebar />
      </div>
