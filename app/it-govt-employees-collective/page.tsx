        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-gray-600 leading-relaxed max-w-3xl mx-auto">
              The ₹1 Crore & ₹50 Lakhs Collectives are a support initiative
              exclusively for IT professionals and government employees. The
              goal is to create a financial safety net for the families of
              members in case of an unfortunate demise. Each member pledges to
              contribute a small amount when a fellow member passes away,
              ensuring their family receives support immediately.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <HowItWorksCard
                ...
                description="IT professionals and Government employees can join this collective by paying a nominal registration and an annual renewal fee of ₹100/-. Need to upload their valid employee ID and nominee details."
              />
              <HowItWorksCard
          ...
          <div className="max-w-3xl mx-auto px-4">
            ...
            <ul className="space-y-4">
              ...
              <BenefitItem>
                ...
                ensuring financial security among IT and government employees.
              </BenefitItem>
            </ul>
          </div>
        </section>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600 text-sm">
                <BenefitItem>
                  ...
                  and consistently to this collective's fund.
                </BenefitItem>
                <BenefitItem>
                  <strong>Maintain Integrity:</strong> Providing accurate
                  personal information and adhering to the collective's
                  guidelines.
                </BenefitItem>
                <BenefitItem>
                  <strong>Promote Transparency:</strong> Engaging in open
                  communication and participating in decision-making processes.
                </BenefitItem>
                <BenefitItem>
                  <strong>Foster Community Growth:</strong> Encouraging others
                  to join and strengthen our collective.
                </BenefitItem>
                <BenefitItem>
                  <strong>Respect Confidentiality:</strong> Honouring the
                  privacy of fellow members with utmost care.
                </BenefitItem>
                <BenefitItem>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <ul className="space-y-3 text-gray-600 text-sm list-disc list-inside">
              ...
              <li>
                The full claim value promises the IT & Govt. plan is assured;
                the actual amount depends on contributions received.
              </li>
              <li>
